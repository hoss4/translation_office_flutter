...
class UpAppInfo extends StatefulWidget {
  ...
  @override
  State<UpAppInfo> createState() => _UpAppInfoState();
}

class _UpAppInfoState extends State<UpAppInfo> {
  @override
          ...
          children: [
            ...
            Center(
              child: CupertinoButton(
                onPressed: () async {
                  var res = await TranslatorApi.cancelAppointement(
            ...
            CupertinoDialogAction(
                ...
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => const UpcomingApp()));
                })
          ]);
