...
import 'package:translation_office_flutter/pages/translatorpages/prev_app_details.dart';
import 'package:translation_office_flutter/services/translator_api.dart';

class PrevApp extends StatefulWidget {
  const PrevApp({super.key});

  @override
  State<PrevApp> createState() => _PrevAppState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<dynamic>>(
          future: TranslatorApi.getpreviousTranslations(),
