...
class PrevRequestInfo extends StatefulWidget {
  ...
  @override
  State<PrevRequestInfo> createState() => _PrevRequestInfoState();
}

class _PrevRequestInfoState extends State<PrevRequestInfo> {
  @override
