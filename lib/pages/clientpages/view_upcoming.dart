...
class UpRequestInfo extends StatefulWidget {
  ...
  @override
  State<UpRequestInfo> createState() => _UpRequestInfoState();
}

class _UpRequestInfoState extends State<UpRequestInfo> {
  @override
          ...
          children: [
            ...
            Center(
              child: CupertinoButton(
                onPressed: () async {
                  var res =
                      await ClientApi.cancelAppointement(widget.translationid);
                  if (res['status'] == '200') {
                    showCupertinoDialog(
                      context: context,
            ...
            CupertinoDialogAction(
                ...
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => const UpcomingAppointements()));
                })
          ]);
