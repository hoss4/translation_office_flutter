...
class AssignedAppInfo extends StatefulWidget {
  ...
  @override
  State<AssignedAppInfo> createState() => _AssignedAppInfoState();
}

class _AssignedAppInfoState extends State<AssignedAppInfo> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Assigned At : ${widget.acceptedat.day}/${widget.acceptedat.month}/${widget.acceptedat.year}  ${DateFormat.jm().format(widget.acceptedat)}",
                style: const TextStyle(fontSize: 18),
              ),
            ),
            const Divider(
            ...
            Padding(
              ...
              child: Text(
                "Assigned Translator :  ${widget.translatorname}",
                style: const TextStyle(fontSize: 18),
              ),
            ),
            Padding(
            ...
            const Padding(
              ...
              child: Text(
                "Status :  Pending translator's approval",
            ...
            Center(
              child: CupertinoButton(
                onPressed: () async {
                  var res =
                      await AdminApi.unassignRequest(widget.translationid);
                  if (res['status'] == '200') {
                    showCupertinoDialog(
                      context: context,
                ...
                color: Colors.red,
                child: const Text("Unassign Appointement"),
              ),
            ),
            const SizedBox(
              height: 45,
  ...
  Widget createDialog(BuildContext context) => CupertinoAlertDialog(
          ...
          content: const Text(
            "Appointement has been succesfully Unassigned",
            style: TextStyle(
              fontSize: 18,
            ),
          ),
